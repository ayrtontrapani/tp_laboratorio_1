...
int main(void)
{
	...
	do
	{
		...
		{
		case 1:
			printf("\n Ingrese los kilómetros deseados");
		...
		case 2:
			if(flagUno == 0)
			{
					printf("\n Error, debe ingresar los kilómetros en la opción 1");
			}
			else
			{
		...
		case 3:
			if(flagDos == 0)
				{
					printf("\n Error, debe ingresar los precios de los vuelos en la opción 2");
				}
		...
		case 4:
			if(flagTres == 0)
			{
				printf("Error, debe calcular los costos en la opción 3.\n");
			}
			else
			{
